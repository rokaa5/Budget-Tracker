      ...
      <SafeAreaView style={styles.safe}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
          ...
          <View style={styles.amountArea}>
            ...
            <Text style={[styles.amountValue, { color: accent }]}>{formatDisplay()}</Text>
          </View>
            ...
            <View style={styles.chips}>
              {categories.map(cat => {
                ...
                return (
                  <TouchableOpacity
                    key={cat.label}
                    style={[styles.chip, selected && { backgroundColor: accentMuted, borderColor: accent }]}
          ...
          {/* Submit */}
          <TouchableOpacity style={[styles.submitBtn, { backgroundColor: accent }]} activeOpacity={0.8}>
...
const styles = StyleSheet.create({
  ...
  closeBtn: { width: 34, height: 34, borderRadius: 10, backgroundColor: COLORS.card, borderWidth: 1, borderColor: COLORS.border2, alignItems: 'center', justifyContent: 'center' },
  ...
  amountLabel: { color: COLORS.subtext, fontSize: 12, letterSpacing: 0.8, marginBottom: 10 },
  ...
  chip: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: COLORS.card, borderRadius: 20, paddingVertical: 8, paddingHorizontal: 14, borderWidth: 1, borderColor: COLORS.border2 },
  ...
  detailInput: { color: '#888', fontSize: 14, textAlign: 'right', flex: 1, marginLeft: 16 },
  detailValue: { color: '#888', fontSize: 14 },
  divider: { height: 1, backgroundColor: COLORS.border },

  numpad: { backgroundColor: COLORS.card, borderRadius: 16, padding: 8, borderWidth: 1, borderColor: COLORS.border, gap: 4, marginBottom: 24 },
  numpadRow: { flexDirection: 'row', gap: 4 },
  numKey: { flex: 1, borderRadius: 10, padding: 14, alignItems: 'center', justifyContent: 'center' },
  numKeyText: { color: COLORS.white, fontSize: 20, fontWeight: '500' },

  submitBtn: { borderRadius: 16, padding: 18, alignItems: 'center', marginTop: 8 },
